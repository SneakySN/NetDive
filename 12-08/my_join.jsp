							...
							<h1>
								...
								<div class="form-group" style="text-align: center;">
									<div class="btn-group" data-toggle="buttons">
										<label class="btn btn-primary active btn-outline-dark flex-shrink-1"> <input
											type="radio"  style="color:white" name="userGender" autocomplete="off" value="남자"
											checked>남자
										</label> <label class="btn btn-primary btn-outline-dark flex-shrink-1"> <input type="radio"
											style="color:white" name="userGender" autocomplete="off" value="남자">여자
										</label>
									</div>
								</div>
								<div class="btn btn-outline-dark flex-shrink-0" style="margin: auto; width: 90%">
									<input type="text" class="form-control" id="userPassword"
										name="userName" placeholder="이름" maxlength="20">
								</div>
								<br>
								<div class="btn btn-outline-dark flex-shrink-0" style="width: 90% input type="submit" value="회원가입">
